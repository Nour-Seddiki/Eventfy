...
══════════════════════════════════════════ */
function clearErrs() {
  ['errMedia', 'errTitle', 'errCategory', 'errCity', 'errVenue', 'errStartDate', 'errStart', 'errDesc', 'errLocation'].forEach(clrE);
  ['eventTitle', 'eventCategory', 'eventCity', 'venueName', 'startDate', 'startTime', 'eventDesc', 'fullAddress'].forEach(id => remC(id, 'err'));
...
$('publishBtn').addEventListener('click', async () => {
  ...
  try {
    ...
    const currency = localStorage.getItem('eventfy_currency') || 'DZD';
...
(async function initEditMode() {
  ...
  try {
    ...
    if ($('eventCategory')) $('eventCategory').value = ev.category || '';
